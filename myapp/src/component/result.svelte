<script>
	...
	let ansChoosenBYUser = $choose_answer;
	var filtered = ansChoosenBYUser.filter((elm) => elm);
	let unAttempted = 11 - filtered.length;
...
<main>
	<div class="d-flex mx-auto justify-content-center mt-5">
		...
		>
			<div>
				<span class="d-inline-block font18 text-warning"> {unAttempted}</span>
			</div>
